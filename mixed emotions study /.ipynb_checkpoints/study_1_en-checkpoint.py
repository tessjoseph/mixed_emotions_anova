...
class EmotionElicit:
    ...
    def __create_model(self, name):
        model = ChatOpenAI(
            model=name,
            openai_api_key="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",
            ...
            for j in range(3):
                ...
                if j == 1:
                    ...
                    att_list = ['happiness', 'pride', 'sympathy', 'relief', 'hope', 'friendly feeling', \
                                'sadness', 'anxiety', 'anger', 'self-blame', 'fear', 'anger at oneself', 'shame',
                                'guilt', 'jealousy', \
                ...
                if j == 2:
                    ...
                    att_list = ['responsibility for others emotions', 'responsibility for my emotions',
